...
class Profile(models.Model):
    ...
    colour = models.CharField(_("Colour"), max_length=50, default="What is your favourite color?")
    animal = models.CharField(_("Animal"), max_length=50, default="If you were an animal what animal would you like to be?")
